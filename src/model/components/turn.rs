...
impl TurnActor {
    pub fn new(speed: u64) -> Self { Self { speed, alive: true, next_turn_time: 0, actions: VecDeque::new() } }
    ...
    pub fn add_action(&mut self, action: impl GameAction) { self.actions.push_back(Box::new(action)); }
